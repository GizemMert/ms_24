...
def train_eff(
    fold_dataloaders, class_names, num_epochs=150, patience=20, output_dir="results_eff"
):

    os.makedirs(output_dir, exist_ok=True)
    log_file = os.path.join(output_dir, "training_logs_eff.txt")
    ...
    for fold, (train_loader, val_loader, test_loader) in enumerate(fold_dataloaders):
        ...
        torch.save(best_model_state, os.path.join(output_dir, f"best_eff_model_fold{fold + 1}.pth"))
